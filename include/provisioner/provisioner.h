...
/**
 * @brief Provision all registered ITS and KMU entries.
 *
 * All entries are attempted - see logs for per-entry status.
 * Identical ITS content is skipped.
 *
 * @return 0 on success, or the negative errno from the first failure encountered.
 */
