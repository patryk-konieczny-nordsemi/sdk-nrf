...
/**
 * @file provision_entry.h
 * @brief Registration API for runtime provisioner entries (KMU, ITS, callbacks).
 *
 * Plugin translation units include this header and use REGISTER_PROVISION_* macros
 * to link provisioning data into the provisioner image. Requires CONFIG_PROVISIONER.
 */
...
#if !defined(CONFIG_PROVISIONER) && !defined(__DOXYGEN__)
#error "provision_entry.h requires CONFIG_PROVISIONER"
#endif
